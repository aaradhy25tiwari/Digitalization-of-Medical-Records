...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["email"])) {
        ...
        $sql_check = "SELECT * FROM doctor_signup WHERE username = '$check_email'";
    ...
    $sql = "INSERT INTO doctor_signup (phone, username, password, bloodType, UID) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $phone, $email, $password, $blood, $id);
